...
\\
\\
To address this problem, we wanted to introduce a new application designed to make socializing easier and more interesting, enriching students’ university lives.
